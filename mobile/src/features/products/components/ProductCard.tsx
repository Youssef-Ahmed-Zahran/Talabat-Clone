    ...
    return (
      ...
      >
        ...
        <View className="px-1 flex-1">
          <Text
            className="text-[13px] font-bold text-textPrimary text-left leading-[18px]"
            numberOfLines={2}
          >
            {product.name}
          </Text>
  ...
  return (
    ...
    >
      ...
      <View className="flex-1 pr-3 items-start">
        <Text
          className="text-sm font-bold text-textPrimary text-left"
          numberOfLines={2}
        >
          {product.name}
        </Text>
        {product.description ? (
          <Text
            className="text-[11px] text-textSecondary mt-1 leading-normal text-left"
            numberOfLines={2}
          >
            {product.description}
          </Text>
